...
varying highp vec2 vScreenPos;
    ...
    uniform highp float cSSAOQuality;
    ...
    void PS()
    {
        ...
        float hemi = 0.0;
        float maxi = 0.0;
        float screenSample = 1.5;
        int quality_lower = int(cSSAOQuality) * -1;
        int quality_upper = quality_lower * -1;
        for (int x = quality_lower; x <= quality_upper; ++x)
        {
            for (int y = quality_lower; y <= quality_upper; ++y)
            {

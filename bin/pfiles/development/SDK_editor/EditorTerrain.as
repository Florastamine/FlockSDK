...
class TerrainEditor
{
    ...
    void Create()
    {
        ...
        window = LoadEditorUI("ui/SDK/EditorTerrainWindow.xml");
    ...
    {
        String fileName = "textures/HMap" + time.systemTimeUnix  + ".png";
    ...
    {
        ListView@ terrainBrushes = window.GetChild("BrushesContainer", true);
        String brushPath = "textures/SDK/TerrainEditorBrushes/";

...
#include "development/SDK_editor/EditorCubeCapture.as"
...
void SetResourcePath(String newPath, bool usePreferredDir = true, bool additive = false)
{
    ...
    if (!additive)
    {
        ...
        bool isDefaultResourcePath = check.Compare(fileSystem.programDir + "pfiles/", false) == 0 ||
            check.Compare(fileSystem.programDir + "Corepfiles/", false) == 0;

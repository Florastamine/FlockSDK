// Flock editor node transform gizmo handling
...
void CreateGizmo()
{
    ...
    gizmo.model = cache.GetResource("Model", "objects/SDK/Axes.mdl");
    gizmo.materials[0] = cache.GetResource("Material", "materials/SDK/RedUnlit.xml");
    gizmo.materials[1] = cache.GetResource("Material", "materials/SDK/GreenUnlit.xml");
    gizmo.materials[2] = cache.GetResource("Material", "materials/SDK/BlueUnlit.xml");
    gizmo.enabled = false;
...
void PositionGizmo()
{
    ...
    if (editMode != lastGizmoMode)
    {
        ...
        case EDIT_ROTATE:
            gizmo.model = cache.GetResource("Model", "objects/SDK/RotateAxes.mdl");
            break;

        case EDIT_SCALE:
            gizmo.model = cache.GetResource("Model", "objects/SDK/ScaleAxes.mdl");
            break;
        }
...
void UseGizmo()
{
    ...
    {
        gizmo.materials[0] = cache.GetResource("Material", gizmoAxisX.selected ? "materials/SDK/BrightRedUnlit.xml" :
            "materials/SDK/RedUnlit.xml");
        gizmoAxisX.lastSelected = gizmoAxisX.selected;
    }
    if (gizmoAxisY.selected != gizmoAxisY.lastSelected)
    {
        gizmo.materials[1] = cache.GetResource("Material", gizmoAxisY.selected ? "materials/SDK/BrightGreenUnlit.xml" :
            "materials/SDK/GreenUnlit.xml");
        gizmoAxisY.lastSelected = gizmoAxisY.selected;
    }
    if (gizmoAxisZ.selected != gizmoAxisZ.lastSelected)
    {
        gizmo.materials[2] = cache.GetResource("Material", gizmoAxisZ.selected ? "materials/SDK/BrightBlueUnlit.xml" :
            "materials/SDK/BlueUnlit.xml");

// Flock editor hierarchy window handling
...
void CreateHierarchyWindow()
{
    ...
    hierarchyWindow = LoadEditorUI("ui/SDK/EditorHierarchyWindow.xml");
...
void CreateBuiltinObject(const String& name)
{
    ...
    object.model = cache.GetResource("Model", "objects/" + name + ".mdl");

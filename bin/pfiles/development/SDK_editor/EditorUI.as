...
String uiScenePath = fileSystem.programDir + "pfiles/scenes";
String uiElementPath = fileSystem.programDir + "pfiles/ui";
String uiNodePath = fileSystem.programDir + "pfiles/objects";
String uiImportPath;
String uiExportPath;
String uiScriptPath = fileSystem.programDir + "pfiles/";
String uiParticlePath = fileSystem.programDir + "pfiles/particles";
String uiRenderPathPath = fileSystem.programDir + "pfiles/shaders/render";
...
void CreateUI()
{
    ...
    uiStyle = GetEditorUIXMLFile("ui/SDK/DefaultStyle.xml");
    ui.root.defaultStyle = uiStyle;
    iconStyle = GetEditorUIXMLFile("ui/SDK/EditorIcons.xml");
...
void CreateQuickMenu()
{
    ...
    quickMenu = LoadEditorUI("ui/SDK/EditorQuickMenu.xml");
...
{
    contextMenu = LoadEditorUI("ui/SDK/EditorContextMenu.xml");
...
void UpdateWindowTitle()
{
    ...
    if (sceneModified)
        sceneName += "*";
    graphics.windowTitle = SDKEditorTitle + " - " + sceneName;
}
...
XMLFile@ GetEditorUIXMLFile(const String&in fileName)
{
    ...
    String fullFileName = fileSystem.programDir + "pfiles/" + fileName;

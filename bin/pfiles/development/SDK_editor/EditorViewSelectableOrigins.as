...
void CreateOrigin(int index, bool isVisible = false) 
{
    ...
    originsIcons[index].texture = cache.GetResource("Texture2D", "textures/SDK/EditorIcons.png");
    ...
    originsNames[index].SetFont(cache.GetResource("Font", "fonts/SDK/Anonymous Pro.ttf"), NAMES_SIZE);

...
void CreateMaterialEditor()
{
    ...
    materialWindow = LoadEditorUI("ui/SDK/EditorMaterialWindow.xml"); 
...
void InitMaterialPreview()
{
    ...
    previewModel.model = cache.GetResource("Model", "objects/Sphere.mdl");
...
void EditModelPreviewChange(StringHash eventType, VariantMap& eventData)
{
    ...
    {
        case 0:
            previewModel.model = cache.GetResource("Model", "objects/Box.mdl");
            break;
        case 1:
            previewModel.model = cache.GetResource("Model", "objects/Sphere.mdl");
            break;
        case 2:
            previewModel.model = cache.GetResource("Model", "objects/Plane.mdl");
            break;
        case 3:
            previewModel.model = cache.GetResource("Model", "objects/Cylinder.mdl");
            previewModelNode.scale = Vector3(0.8, 0.8, 0.8);
            break;
        case 4:
            previewModel.model = cache.GetResource("Model", "objects/Cone.mdl");
            break;
        case 5:
            previewModel.model = cache.GetResource("Model", "objects/TeaPot.mdl");
            break;
    }
